...
extern "C" {  // only need to export C interface if
	...
	extern __declspec(dllimport) DWORD __stdcall InitPasswordPing(LPTSTR lpszAPIKey, LPTSTR lpszSecret, ULONG ulNetworkTimeoutInMs);
